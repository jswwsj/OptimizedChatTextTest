// MainView.swift
import UIKit
class LabelMainView: UIView {
    
    // MARK: - UI Components
    private var scrollView: UIScrollView!
    private var contentView: UIView!
    private var textLabel: UILabel! // 替换为UILabel
    ...
    private func setupTextLabel() { // 修改方法名
        textLabel = UILabel() // 创建UILabel
    ...
    @objc private func clearText() {
        ...
        textLabel.attributedText = nil // 清空UILabel
        monitorLabel.text = "更新次数: 0"
...
extension LabelMainView: UIScrollViewDelegate {
