...
class TextMainView: UIView {
    
    // MARK: - UI Components
    private var scrollView: UIScrollView!
    private var contentView: UIView!
    private var textView: UITextView! // 替换为UITextView
    ...
    private func setupUI() {
        ...
        textView.attributedText = coreTextStr // 设置UITextView的attributedText
    ...
    private func setupTextView() { // 修改方法名
        textView = UITextView() // 创建UITextView
        textView.translatesAutoresizingMaskIntoConstraints = false
        textView.backgroundColor = .white
        textView.isEditable = false // 禁止编辑
        textView.isSelectable = true // 允许选择文本
        textView.isScrollEnabled = false // 禁用UITextView自身的滚动
        textView.textContainer.lineFragmentPadding = 0 // 移除左右边距
        ...
        NSLayoutConstraint.activate([
            ...
            textView.heightAnchor.constraint(greaterThanOrEqualToConstant: 0) // 最小高度约束
        ])
    }
...
//            self.textView.attributedText = self.coreTextStr
    ...
    @objc private func clearText() {
        ...
        textView.attributedText = nil // 清空UITextView
        monitorLabel.text = "更新次数: 0"
...
extension TextMainView: UIScrollViewDelegate {
